        ...
        Vue.mixin({
            created: function created() {
                ...
                this.$options.channels = new Proxy({}, {
                    set: function set(target, key, value) {
                        ...
                        var chan = _this.$socket.channel(key, {});
                        var _chan = chan.join();
                ...
                if (channels) {
                    Object.keys(channels).forEach(function (key) {
                        _this.$options.channels[key] = channels[key];
                    });
                }
            },
            beforeDestroy: function beforeDestroy() {
                ...
                if (channels) {
                    Object.keys(channels).forEach(function (key) {
                        console.log("Bye", key);
                        _this2.$options.channels[key].leave();
                        delete _this2.$options.channels[key];
                    });
                }
            }
        });
...
(function (global, factory) {
  ( false ? 'undefined' : _typeof2(exports)) === 'object' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.Phoenix = global.Phoenix || {});
